...
#excluding date (-3)
knn1 <-  knn(sj.train.train[,c(-3,-20)], sj.train.test[,c(-3,-20)], sj.train.train[,20], k=10, l=1)
library(MLmetrics)
MAE(as.numeric(knn1),sj.train.test[,20])
RMSE(as.numeric(knn1),sj.train.test[,20])
R2_Score(as.numeric(knn1),sj.train.test[,20])
sj.train.test$pred <- as.numeric(knn1)
...
#excluding date (-3)
knn1 <-  knn(iq.train.train[,c(-3,-20)], iq.train.test[,c(-3,-20)], iq.train.train[,20], k=10, l=1)
library(MLmetrics)
MAE(as.numeric(knn1),iq.train.test[,20])
RMSE(as.numeric(knn1),iq.train.test[,20])
R2_Score(as.numeric(knn1),iq.train.test[,20])
iq.train.test$pred <- as.numeric(knn1)
